# -*- coding: utf-8 -*-
"""Toll Prediction System.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DUu2GH1oYxAgy14TfzD_wf1AQuzwlv5g
"""
...
# col_baslik, col_logo = st.columns([5, 1]) # Başlık 5 birim, Logo 1 birim yer kaplar
# 
# with col_baslik:
#     st.title("🛠️ TOMTAŞ LIFT-UP: AI Takım Ömrü Asistanı")
# 
# with col_logo:
#     # Logonun sağ üstte şık durması için dosya kontrolü
#     if os.path.exists("agtoe.png"):
#         st.image("agtoe.png", width=150) # Genişliği sağ üst için 150px olarak sabitledim
...
# BURAYA KENDİ ŞİFRENİ YAPIŞTIR!
ngrok.set_auth_token("3DTtKa2Xc3rxaxjfzelIpCdXqDe_59aRHSoVdLxdiDESXsT5f")

# Tüneli başlatıyoruz
public_url = ngrok.connect(8501)
print(f"🚀 Sitenin GÜVENLİ ve HIZLI Linki: {public_url}")

# Uygulamayı arka planda çalıştırıyoruz
